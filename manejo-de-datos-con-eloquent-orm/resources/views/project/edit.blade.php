...
@section('content')
<h1 class="text-5xl text-center mb-5 dark:text-white">Editing <span class="font-extrabold">{{ $project->name }}</span></h1>
...
<form class="max-w-sm mx-auto" method="POST" action="{{ route('project.store') }}">
    ...
    <div class="mb-5">
        ...
        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="name" value="{{ $project->name }}" required />
    </div>
    <div class="mb-5">
        ...
        <div class="relative max-w-sm">
            ...
            <input datepicker type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" name="execution_date" value="{{ $project->execution_date->format('m/d/Y') }}" required>
        </div>
    </div>
    <div class="flex items-start mb-5">
        <div class="flex items-center h-5">
            <input type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" value="1"  name="is_active" @checked($project->is_active) />
        </div>
